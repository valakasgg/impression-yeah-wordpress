...
define('DB_NAME', 'digimarma-live-3138340b7b');
define('DB_USER', 'digimarma-live-3138340b7b');
define('DB_PASSWORD', 'Vxzt*4GN-Myips*.2-tmY8qEcJD8HkXvxRDLEGBpNxi-W4qQ*P');
define('DB_HOST', 'sdb-f.hosting.stackcp.net');
