...
// define('DB_HOST', 'mysql.stackcp.com:56691');
...
define('WP_SITEURL', 'http://' . $_SERVER['HTTP_HOST'] . '/yeah');
define('WP_HOME', 'http://' . $_SERVER['HTTP_HOST'] . '/yeah');

// define('WP_SITEURL', 'http://' . $_SERVER['HTTP_HOST'] . '/anglo-stainless');
// define('WP_HOME', 'http://' . $_SERVER['HTTP_HOST'] . '/anglo-stainless');
